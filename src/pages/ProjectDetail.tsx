...
const projectsData: Record<string, any> = {
  "bnp-omnicanalite-b2c": {
    ...
    team: ["1 Product Owner", "2 Product Designers", "3 Développeurs front-end", "1 Lead Tech"],
    collaboration:
    ...
    process: [
      ...
      },
      {
        ...
        activities: ["Tests utilisateurs en agence", "Itérations sur les retours", "Validation métier et conformité"],
